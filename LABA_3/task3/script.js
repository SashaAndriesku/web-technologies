function getMonthName() {
    let input = prompt("Введіть число від 1 до 12:");
    let monthNumber = parseInt(input);
    let monthName;
    ...
    switch (monthNumber) {
        ...
        default: monthName = "Некоректне число! Введіть від 1 до 12.";
    }

    console.log("Завдання 3: " + monthName);
}